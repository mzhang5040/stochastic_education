...
for i, x in enumerate(xs):
    ...
    axA.text(x, y - 0.55, sub[i], ha="center", va="top", fontsize=7.2, color="#444")
...
axA.text(0.5, 0.52, "adjacent up", color="#1f4e79", fontsize=8, ha="center")
axA.text(3.5, -0.52, "adjacent down", color="#8a8a8a", fontsize=8, ha="center")
...
axA.text(2.0, 1.28, "non-adjacent moves: dashed, weight $\\propto\\rho^{|j-i|-1}$ "
         "($\\rho=0.7$)", ha="center", fontsize=8, color="#7a7a7a")
